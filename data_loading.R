...
ela1 <- select(ela_nowe, P_NAZWA_UCZELNI, P_KIERUNEK_NAZWA, P_POZIOM, P_FORMA, 
               ...
               P_E_ZAR_P1, P_E_ZAR_P2, P_E_ZAR_P3, P_E_ZAR_P4, P_E_ZAR_P5,
               P_CZAS_PRACA, P_CZY_BEZR, P_WWZ, P_WWB)
  #zmienne do porównania - dodanie średnich zarobków P_E_ZAR_Pn
  # pivot_longer(cols = 10:23, names_to = "zmienna", values_to = "wartosc") usunięcie pivotowania w data_loading
